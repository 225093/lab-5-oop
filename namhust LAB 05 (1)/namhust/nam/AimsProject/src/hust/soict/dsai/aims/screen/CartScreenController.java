...
public class CartScreenController {
    ...
    private Cart cart;
    private Store store;
    private FilteredListCustom filteredListCustom;
    @FXML
    ...
    private void initialize() {
        ...
        ObservableList<Media> originalList = this.cart.getItemsOrdered();
        filteredListCustom = new FilteredListCustom(originalList);
        ...
        updateTotalCost();
         ...
         filterTextField.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                filteredListCustom.showFilteredMedia(newValue, radioBtnFilterId.isSelected());
                 tblMedia.setItems(filteredListCustom.getFilteredList());
            }
        });
    }
